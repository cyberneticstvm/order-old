...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->decimal('advance', 7, 2)->default(0.00);
            ...
            $table->unsignedBigInteger('advance_payment_type')->references('id')->on('payment_modes')->default(0);
            $table->unsignedBigInteger('balance_payment_type')->references('id')->on('payment_modes')->default(0);
