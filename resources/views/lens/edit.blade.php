                    ...
                    <form action="{{ route('stock.tracking.update', $product->id) }}" method="post">
                        ...
                        <div class="row g-4">
                            <div class="col-sm-3">
                                ...
                                <select name="location_id" class="form-control show-tick ms select2">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select name="material_id" class="form-control show-tick ms select2">
                                    <option value="">Select</option>
                            ...
                            <div class="col-sm-3">
                                ...
                                <select name="coating_id" class="form-control show-tick ms select2">
                                    <option value="">Select</option>
                            ...
                            <div class="col-sm-2">
                                ...
                                <select class="form-control select2" name="eye">
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="text" name="sph" class="form-control" value="{{ $product->sph }}" placeholder="SPH" maxlength="6">
                            </div>
                            <div class="col-sm-2">
                                <label class="form-label">CYL</label>
                                <input type="text" name="cyl" class="form-control" value="{{ $product->cyl }}" placeholder="CYL" maxlength="6">
                            </div>
                            <div class="col-sm-2">
                                <label class="form-label">AXIS</label>
                                <input type="text" name="axis" class="form-control" value="{{ $product->axis }}" placeholder="AXIS" maxlength="6">
                            </div>
                            <div class="col-sm-2">
                                <label class="form-label">ADD</label>
                                <input type="text" name="add" class="form-control" value="{{ $product->add }}" placeholder="ADD" maxlength="6">
                            </div>
                            <div class="col-sm-2">
                                <label class="form-label">Qty</label>
                                <input type="number" name="qty" class="form-control" value="{{ $product->qty }}" placeholder="0">
                            </div>
                            <div class="col-sm-3">
                                <label class="form-label">Shelf</label>
                                <input type="text" name="shelf" class="form-control" value="{{ $product->shelf }}" placeholder="Shelf">
                            </div>
                            <div class="col-sm-3">
                                <label class="form-label">Box</label>
                                <input type="text" name="box" class="form-control" value="{{ $product->box }}" placeholder="Box">
                            </div>
