                    ...
                    <form action="{{ route('stock.tracking.save') }}" method="post">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="text" name="sph" class="form-control" value="{{ old('sph') }}" placeholder="SPH" maxlength="6">
                            </div>
                            <div class="col-sm-2">
                                <label class="form-label">CYL</label>
                                <input type="text" name="cyl" class="form-control" value="{{ old('cyl') }}" placeholder="CYL" maxlength="6">
                            </div>
                            <div class="col-sm-2">
                                <label class="form-label">AXIS</label>
                                <input type="text" name="axis" class="form-control" value="{{ old('axis') }}" placeholder="AXIS" maxlength="6">
                            </div>
                            <div class="col-sm-2">
                                <label class="form-label">ADD</label>
                                <input type="text" name="add" class="form-control" value="{{ old('add') }}" placeholder="ADD" maxlength="6">
                            </div>
                            <div class="col-sm-2">
                                <label class="form-label">Qty</label>
                                <input type="number" name="qty" class="form-control" value="{{ old('qty') }}" placeholder="0">
                            </div>
                            <div class="col-sm-3">
                                <label class="form-label">Shelf</label>
                                <input type="text" name="shelf" class="form-control" value="{{ old('shelf') }}" placeholder="Shelf">
                            </div>
                            <div class="col-sm-3">
                                <label class="form-label">Box</label>
                                <input type="text" name="box" class="form-control" value="{{ old('box') }}" placeholder="Box">
                            </div>
