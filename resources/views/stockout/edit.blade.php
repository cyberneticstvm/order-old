...
<div class="body-header d-flex py-3">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-auto">
                <h1 class="fs-4 mt-1 mb-0">Update Stock Transfer</h1>
                <small class="text-muted">Inventory / Update Stock Transfer</small>
            </div>
        </div>
    </div>
</div>
                    ...
                    <form action="{{ route('stockout.update', $stockout->id) }}" method="post">
                        ...
                        <div class="row g-4">
                            <div class="col-sm-2">
                                ...
                                <input type="date" value="{{ $stockout->transfer_date->format('Y-m-d') }}" name="transfer_date" class="form-control form-control-md" placeholder="Transfer Date" >
                                @error('transfer_date')
                            ...
                            <div class="col-sm-3">
                                ...
                                {!! Form::select('from_branch', $branches->pluck('name', 'id')->all(),  $stockout->details->first()->from_branch, ['class' => 'form-control form-control-sm select2', 'placeholder' => 'Select']) !!}
                                @error('from_branch')
                            ...
                            <div class="col-sm-3">
                                ...
                                {!! Form::select('to_branch', $branches->pluck('name', 'id')->all(),  $stockout->details->first()->to_branch, ['class' => 'form-control form-control-sm select2', 'placeholder' => 'Select']) !!}
                                @error('to_branch')
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" value="{{ $stockout->notes }}" name="notes" class="form-control form-control-md" placeholder="Notes / Remarks">
                            </div>                     
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-12">
                            ...
                            <div class="col-12 table-responsive mt-3">
                                <table class="tblOrder table table-bordered table-sm">
                                    ...
                                    <tbody class="tblStock">
                                        @forelse($stockout->details as $key => $product)
                                        <tr>
                                            <td>
